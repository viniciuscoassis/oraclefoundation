      ...
      <div className="h-screen">
        ...
        <main className="min-h-screen bg-black text-white">
          ...
          <div className="text-center p-12">
            ...
            <button className="bg-atomic-tangerine-hex hover:brightness-90 text-white font-bold py-2 px-4 rounded-full my-5">
        ...
        <main className="bg-charcoal-hex text-white">
          ...
          <section className="text-center py-12">
            ...
            <button className="bg-atomic-tangerine-hex hover:brightness-90 text-white font-bold py-2 px-4 rounded-full">
              Join our Discord
            </button>
          </section>
        ...
        <footer className="bg-charcoal-2-hex py-8">
          <div className="container mx-auto px-4">
            <p className="text-center">Oracles 2024 </p>
          </div>
        </footer>
      </div>
    </>
